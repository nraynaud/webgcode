...
function program7(depth0,data) {
  ...
  stack1 = helpers['if'].call(depth0, "isConnected", {hash:{},hashTypes:{},hashContexts:{},inverse:self.program(7, program7, data),fn:self.program(1, program1, data),contexts:[depth0],types:["ID"],data:data});
  if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
  data.buffer.push("\n</div>");
  return buffer;
...
function program5(depth0,data) {
  ...
  data.buffer.push(">");
  stack1 = (helper = helpers['link-to'] || (depth0 && depth0['link-to']),options={hash:{},hashTypes:{},hashContexts:{},inverse:self.noop,fn:self.program(6, program6, data),contexts:[depth0,depth0],types:["STRING","ID"],data:data},helper ? helper.call(depth0, "operation", "", options) : helperMissing.call(depth0, "link-to", "operation", "", options));
  if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
  ...
  data.buffer.push(" title=\"Delete Operation\"><i class=\"fa fa-times\"></i></a>\n            </li>\n        ");
  return buffer;
  }
function program6(depth0,data) {
...
function program8(depth0,data) {
  ...
  data.buffer.push("</td>\n        </tr>\n        </tbody>\n    </table>\n    <h2>Shapes</h2>\n    <ul class=\"list-group\">\n        ");
  stack1 = helpers.each.call(depth0, "shapes", {hash:{},hashTypes:{},hashContexts:{},inverse:self.program(3, program3, data),fn:self.program(1, program1, data),contexts:[depth0],types:["ID"],data:data});
  if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
  data.buffer.push("\n    </ul>\n    <h2>Operations</h2>\n    <ul class=\"list-group\">\n        ");
