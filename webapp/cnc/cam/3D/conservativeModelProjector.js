...
define([], function () {
    ...
    function Projector() {
        ...
        this.vertexShader = [
            ...
            // grab the distance from the 2D projected point to it's projection on the triangle plane
        ...
        this.fragmentShader = [
            ...
            '        discard;',
            // ok, we were pessimistic and stuff, but one thing still holds true:
            // the true Z value can never ever be higher than any Z value of the input vertices,
    ...
    Projector.prototype = {
        ...
        setGeometry: function (meshGeometry) {
            ...
            this.model.add(mesh);
            this.modelBbox = this.computeCameraBoundingBox().expandByScalar(10);
