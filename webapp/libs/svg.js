...
(function () {
    ...
    SVG.regex = {
        ...
        /* parse unit value */, unit: /^([\d\.]+)([a-z%]{0,2})$/
        ...
        /* test css property */, isStyle: /^font|text|leading|cursor/
    ...
    SVG.defaults = {
        ...
        , attrs: {
            /* fill and stroke */
            'fill-opacity': 1, 'stroke-opacity': 1, 'stroke-width': 0, 'stroke-linejoin': 'miter', 'stroke-linecap': 'butt', fill: '#000', stroke: '#000', opacity: 1
            /* position */, x: 0, y: 0, cx: 0, cy: 0
            /* size */, width: 0, height: 0
            /* radius */, r: 0, rx: 0, ry: 0
            /* gradient */, offset: 0, 'stop-opacity': 1, 'stop-color': '#000'
        }
    ...
    SVG.extend(SVG.Element, {
        ...
        , size: function (width, height) {
            return this.attr({
                width: new SVG.Number(width), height: new SVG.Number(height)
            })
        }
        // Clone element
        , clone: function () {
    ...
    SVG.extend(SVG.FX, {
        ...
        , size: function (width, height) {
            if (this.target instanceof SVG.Text) {
                ...
                this._size = {
                    width: { from: box.width, to: width  }, height: { from: box.height, to: height }
                }
            }
        ...
        , viewbox: function (x, y, width, height) {
            if (this.target instanceof SVG.Container) {
                ...
                this._viewbox = {
                    x: { from: box.x, to: x      }, y: { from: box.y, to: y      }, width: { from: box.width, to: width  }, height: { from: box.height, to: height }
                }
            }
        ...
        , _color: function (o, pos) {
            ...
            return new SVG.Color({
                r: ~~(from.r + (to.r - from.r) * pos), g: ~~(from.g + (to.g - from.g) * pos), b: ~~(from.b + (to.b - from.b) * pos)
            }).toHex()
        }
    ...
    SVG.extend(SVG.Ellipse, {
        ...
        , size: function (width, height) {
            return this.attr({
                rx: new SVG.Number(width).divide(2), ry: new SVG.Number(height).divide(2)
            })
        }
    ...
    SVG.extend(SVG.Polyline, SVG.Polygon, SVG.Path, {
        ...
        , size: function (width, height) {
            ...
            return this.transform({
                scaleX: scale, scaleY: height != null ? height / this._offset.height : scale
            })
        }
        // Set path data
        , plot: function (data) {
    ...
    SVG.Text = function () {
        ...
        this.styles = {
            'font-size': 16, 'font-family': 'Helvetica, Arial, sans-serif', 'text-anchor': 'start'
        }
    ...
    SVG.extend(SVG.Text, {
        ...
        , rebuild: function () {
            ...
            for (i = 0, il = this.lines.length; i < il; i++)
                this.lines[i].attr({
                    dy: size * this._leading - (i == 0 ? size * this._base : 0), x: (this.attr('x') || 0), style: this.style()
                })
